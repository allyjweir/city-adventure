...
public class MockDatabase {
    ...
    protected MockDatabase() {
        ...
        landmarks.put("UKGLAKELVINGROVE", new Landmark("Kelvingrove Art Gallery and Museum", "The Kelvingrove Art Gallery and Museum is a museum and art gallery in Glasgow, Scotland.",
                ...
                null, 1037594));
        landmarks.put("UKGLAHILLHEADSUB", new Landmark("Hillhead Subway Station", "Hillhead subway station is a station on the Glasgow Subway, serving the Hillhead area of Glasgow, Scotland.",
        ...
        landmarks.put("UKGLAHUNTERIAN", new Landmark("Hunterian Museum and Art Gallery",
        ...
        landmarks.put("UKGLARIVERSIDEMUS", new Landmark("Riverside Museum",
        ...
        landmarks.put("UKGLAUNIGLASGOW", new Landmark("University of Glasgow",
        ...
        cities.put("UKGLA", new City("Glasgow", "Glasgow is the largest city in Scotland, and the third largest in the United Kingdom." +
        ...
        cities.put("UKEDI", new City("Edinburgh", "Edinburgh is the capital city of Scotland, situated in Lothian on the southern shore of the Firth of Forth. It is the second most populous city" +
        ...
        achievements.put("AAAA001", new Achievement("City Adventurer", "The simplest of achievements",
        ...
        tasks.put("UKGLAKELVINGROVE001", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "Sir Roger,Sir David,Sir Remmy,Sir Ballantyne".split(","),
                0,"What is the name of the large elephant housed here?"));
        tasks.put("UKGLAKELVINGROVE002", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "Seahawk,Blackburn Ripon,Spitfire,Airspeed Oxford".split(","),
                2,"What WWII aircraft is suspended from the roof?"));
        tasks.put("UKGLAKELVINGROVE003", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "Cello,Bagpipes,Piano,Organ".split(","),
                3,"Which instrument is performed on everyday in the museum?"));
        tasks.put("UKGLAKELVINGROVE004", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "55,32,16,27".split(","),
                2,"How many heads are suspended in the Expression gallery?"));
        tasks.put("UKGLAKELVINGROVE005", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "1901,1066,1921,1898".split(","),
                0,"Which year was the museum opened?"));
        tasks.put("UKGLAKELVINGROVE006", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "Newspaper story,Bible,A Dream,Cloudspotting".split(","),
                2,"Where did Salvador Dalí get his influence for \"Christ of Saint John of the Cross\"?"));
        tasks.put("UKGLAKELVINGROVE007", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "8,55,24,14".split(","),
                2,"How many birds are in the museum"));
        tasks.put("UKGLAKELVINGROVE008", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "5,2,1,6".split(","),
                1,"How many Polar Bears are there?"));
        tasks.put("UKGLAKELVINGROVE009", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "12,36,6,22".split(","),
                3,"How many galleries are there?"));
        tasks.put("UKGLAKELVINGROVE010", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAKELVINGROVE", "Alasdair Gray,James Docharty,David Simmons,Sydney Elmer Schofield".split(","),
                1,"Who painted \"Head of the Holy Loch\""));
        tasks.put("UKGLAHILLHEADSUB001", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAHILLHEADSUB", "Sir Roger,Sir David,Sir Remmy,Sir Ballantyne".split(","),
                0,"What is the name of the large elephant housed here?"));
        tasks.put("UKGLAHILLHEADSUB002", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAHILLHEADSUB", "£3,£4.50,£2.75,£1.80".split(","),
                0,"How much is a return ticket?"));
        tasks.put("UKGLAHILLHEADSUB003", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAHILLHEADSUB", "1900,1856,1914,1896".split(","),
                3,"When did the subway open?"));
        tasks.put("UKGLAHILLHEADSUB004", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAHILLHEADSUB", "3,4,1,3".split(","),
                2,"How many stops away is Kelvinbridge Station?"));
        tasks.put("UKGLAHILLHEADSUB005", new Task.QuestionTask(Task.TaskType.QUESTION, "UKGLAHILLHEADSUB", "The Shoogle,The Woogie,The Clickity,The Back and Forth".split(","),
